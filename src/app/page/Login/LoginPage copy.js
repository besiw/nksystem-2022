...
import { darken } from '@mui/styles/colorManipulator';
...
const useStyles = makeStyles(theme => ({
	root: {
		background: `linear-gradient(to left, #454d73 0%, ${darken(theme.palette.primary.dark, 0.5)} 100%)`,
		color: theme.palette.primary.contrastText
	},
	leftSection: {},
	rightSection: {
		background: `linear-gradient(to right, rgba(108, 119, 170) 0%, ${darken(
